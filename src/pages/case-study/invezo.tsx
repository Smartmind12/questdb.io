      ...
      <section className={seCss.section}>
        ...
        >
          ...
          <p className="font-size--large">
            ...
            startup which aims to become the gold standard for digital assets
          ...
          <p className="font-size--large">
            Emmett Miller, co-founder of Invezo, tells us about his journey
            building his company using QuestDB Cloud.
          </p>
          ...
          <p className="font-size--large">Query execution time: 5.4 seconds</p>

          <CodeBlock title="QuestDB Query">{questDBQuery}</CodeBlock>

          <p className="font-size--large">Query execution time: 0.1 seconds</p>
