...
_This is a brand-new series: developr stories, for which we interviewed
developers in our community for their actual experience building with QuestDB.
For the first post of this series, we are trilled to interview Kevin Kamto,
